        ...
        <div class="container">
            ...
            <div class="row row-offset-2 justify-content-md-center">
                <div class="col-xl-10">
                    ...
                    <a class="button button-icon button-icon-right button-primary big buttons-inset-horizontal-15 float-right" href="{{ route('kontakt') }}" target="_blank"><span class="icon icon-xs fa-angle-right"></span>Máte ďalšie otázky?</a>
                </div>
            </div>
        </div>
    </section>
