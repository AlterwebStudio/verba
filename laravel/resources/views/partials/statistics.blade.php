<section class="section parallax-container bg-black" data-parallax-img="images/home-slider-1-slide-4.jpg">
    <div class="parallax-content">
        <div class="section-60 section-md-100 overlay-9">
            <div class="container">
                <h3 class="text-center">Do dnešného dňa sa nám podarilo...</h3>
                <div class="row row-40 row-offset-1 align-items-sm-end">
                    <div class="col-sm-6 col-md-3">
                        <div class="box-counter"><span class="icon icon-11"></span>
                            <div class="text-large counter">16</div>
                            <h5 class="box-header">rokov na trhu</h5>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="box-counter"><span class="icon icon-12"></span>
                            <div class="text-large counter">510</div>
                            <h5 class="box-header">spokojných klientov</h5>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="box-counter"><span class="icon icon-13"></span>
                            <div class="text-large counter">1180</div>
                            <h5 class="box-header">prekladov</h5>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="box-counter"><span class="icon icon-14"></span>
                            <div class="text-large counter">37</div>
                            <h5 class="box-header">prekladateľov</h5>
                        </div>
                    </div>
                </div>
            </div>
